...
export const appEditorTheme = createTheme({
  ...
  styles: [
    { tag: tags.string, color: '#6ec887' },
    { tag: tags.number, color: '#6db8e8' },
    { tag: tags.bool, color: '#eb9898' },
    { tag: tags.null, color: '#eb9898' },
    { tag: tags.propertyName, color: '#bfa8f8' },
    { tag: tags.keyword, color: '#eb9898' },
    { tag: tags.comment, color: '#95a0b0' },
    { tag: tags.punctuation, color: 'var(--color-text-primary)' },
    { tag: tags.bracket, color: 'var(--color-text-primary)' },
    { tag: tags.separator, color: 'var(--color-text-primary)' },
    { tag: tags.variableName, color: '#e8c888' },
    { tag: tags.typeName, color: '#6db8e8' },
    { tag: tags.definition(tags.variableName), color: '#bfa8f8' },
  ],
});
